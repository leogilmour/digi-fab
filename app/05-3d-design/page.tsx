  ...
  return (
    <div className="p-2 px-8 py-8 pb-16 sm:px-32">
      ...
      <h3 className="text-df-shade-lighter mb-8 text-2xl">
        Design and 3D print a component
      </h3>
      <WideGrid>
        <WideContainer>
          <p>
            Even though itʼs not my final project, iterating on my kinetic
            sculpture is a great framework for learning new skills. On reviewing
            my jewellery carousel prototype I wanted to create a bespoke fitting
            for the jewellery to replace the bulldog clips. This was not
            something I was able to do (obviously) in 2D parts. For extra jshzsh
            I designed a star-shaped hook. This allows earrings to sit in the
            lower star points but also little arms to support a necklace.
          </p>
          <br />
          <p>
        ...
        <WideContainer>
          ...
          <p>
            ...
            chose a complex print orientation. This is because the Prusa Slicer
            prints 2D layers which fuse together. The fusing together of the
            layers is not as strong as the strength within the layer itself.
          </p>
          <br />
          <p>
        ...
        <WideContainer>
          <p>
            ...
            green one that would reduce organic supports while, hopefully, still
            optimising for the expected force directions. There is a weakness
            between the loop around the screw and the arm holding the star which
            is fairly critical. We will have to see what happens.
          </p>
        ...
        <WideContainer>
          ...
          <br />
          <p>
            Screwing the screw into the star hook was quite difficult and I was
            a little concerned about the PLA slices holding but since I want the
            hook to rotate with the screw itʼs good itʼs a tight fit. If the
            screw rotates within the hook, itʼs a fail. This being said, I am
            surprised I didnʼt accommodate a kerf-like parameter into my design,
            e.g. screwDiam + kerf, to take the additive tolerance into
            consideration. I restarted my design at some point so perhaps I
            dropped the param.
            <br />
      ...
      <br />
      <h3 className="text-df-shade-lighter my-8 text-2xl">3D Scanning</h3>
      <WideGrid>
        <WideContainer>
          <p>
        ...
        <WideContainer>
          ...
          <br />
          <p>
            To be honest I have no idea if the revo file works without the data
            folder but I did not want to add 130MB to my Github repo (which I
            think would be irreversible!)
          </p>
          <br />
      ...
      <WideGrid>
        <div className="max-w-2xl">
          ...
          <br />
          <p>
            As part of my refining the carousel, I have been designing 2D pieces
            that can slot together to create the base.
          </p>
          <br />
          <p>
      ...
      <h3 className="text-df-shade-lighter my-8 text-2xl">
        Final project, a bill of materials, timeline, and project goals
      </h3>
      <ProjectGoals />
      <PredictedBillOfMaterials />
      <PredictedTimeline />
