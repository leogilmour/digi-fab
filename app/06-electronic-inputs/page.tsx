  ...
  return (
    <div className="p-2 py-8 pb-16 sm:px-4 md:px-6 lg:px-8">
      ...
      <WideGrid>
        <WideContainer>
          <p>
            Since boiling water is a key part of my final project, I will use a
            thermistor and calibrate it to detect boiling water. This will
        ...
        <WideContainer>
          <p>
            <i>Fun fact:</i> this took me ages to debug because someone had put
            the wrong resistor in the 10k box 😭. This meant my voltage divider
            wasnʼt functioning and I could only read 0 or 4095 depending on my
            setup. Lesson learnt!
          </p>
          <PlainMediumImage
        ...
        <WideContainer>
          ...
          <p>
            ...
            input voltage, whether 3.3V or 5V, it will return 4095. Instead, you
            can alter the precision of the readings (mapping one range to
        ...
        <WideContainer>
          ...
          <p>
            The total resistance of the series circuit is R = 10kΩ + resistance
            of the thermistor. The voltage drop across the first resistor can be
            found as a ratio of 10kΩ divided by the total. Similarly, the drop
            across the thermistor is the thermistor resistance / total R.
            <br />
            The changing thermistor changes the ratio (around the median of the
            fixed resistor). When the thermistor is at 10kΩ they each receive
            half of the voltage (10 / 10 + 10). At 3kΩ, around 1/4, and at 30kΩ,
            3/4.
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            From these initial values, it appears that the hotter the thermistor
            gets, the lower the voltage it is allocated, therefore a smaller
            resistance. General rules of charge imply that heat increases
            conductivity, therefore a lower resistance is expected!
          </p>
        </WideContainer>
      </WideGrid>
      ...
      <WideGrid>
        <WideContainer>
          ...
          <br />
          <p>
            The physical set up is extremely simple: two copper strips stuck to
            the vessel. Then, use the capacitance of water compared with air to
            determine the level of water.
          </p>
          <br />
          <p>
        ...
        <WideContainer>
          <p>
            To change the range, I imagine I could alter the area of the copper
            strips and the height of copper strips. The distance between the
            copper strips would impact the capacitance and the temperature of
            the water may affect its permittivity. Even with changes to its
            permittivity, the difference between water at 80 and air at 1 means
            it would likely be comparatively negligible.
          </p>
          <br />
          <p>Capacitance = ε x Area / distance between</p>
          <br />
          <p>
            where ε is permittivity. The area of the copper plates and distance
            between them is constant, so only the permittivity of water vs air
            will impact the measure of capacitance.
          </p>
        </WideContainer>
        <WideContainer>
      ...
      <WideGrid>
        <WideContainer>
          <p>
            I taped my thermistor to the side of my water-level-sensing bottle.
            There is a risk that this plastic bottle will melt, so I will only
            experiment with near-boiling water.
          </p>
          <p>
            The important measurements are: empty state, room temperature water,
            and boiling water.
          </p>
          <br />
          ...
          <br />
          <p className="w-full text-left">
            <i>if</i> (water level is less than 10 && thermistor reading is less
            than 1000 && some variable to track if the water boiled recently)
          </p>
          <p className="w-full text-left">
