...
export default function Page() {
  return (
    <WeeklyWrapper week={2}>
      <div className="p-2 px-8 py-8 pb-16 sm:px-32">
        <h1 className="my-4 mb-12 text-center text-3xl">
          Week 1 Part 2: 2D Design + cutting
        </h1>
        <FunH2>01: Make a Box</FunH2>
        <WideGrid>
          <WideContainer>
            I designed my shoebox in a 2D sketch in Fusion. I didnʼt elaborate
            further than adding a handle! Oops! Then I got the lasercutter to
            sear it into some cardboard. I was quite unsure about the kerf... in
            the end I decided to make the teeth larger by the kerf amount
            (0.3mm) and the gaps smaller by the kerf amount... it seemed to do
            the job but this could perhaps be improved for future cuts. (Which
            is always more simple with parameters! Modify ➡️ Change parameters)
            <PlainMediumImage
          ...
          <WideContainer>
            <p>
              ...
              exported the PNG file. Then, using Inkscape, the cutter sketched
              it onto a red vinyl sheet. ❤️ To be honest, I messed up the end of
              the ʼoʼ and I had to finish it by hand...!
            </p>
            <style>
              {`@keyframes rainbow {
                  0%   { background: #ff6464; }
          ...
          <WideContainer>
            ...
            box! (I misread the assignment and thought we were required to cut
            out the useless box too!)
            <MobileImage
        ...
        <FunH2>02: Fusion 360 Tutorial</FunH2>
        <WideGrid>
          <WideContainer>
            <p>
        ...
        <FunH2>03: Fusion Modelling</FunH2>
        <WideGrid>
          <WideContainer>
