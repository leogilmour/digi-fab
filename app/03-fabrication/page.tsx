  ...
  return (
    <WeeklyWrapper week={3}>
      <div className="p-2 px-8 py-8 pb-16 sm:px-32">
        ...
        <FunH2>Kinetic Sculpture</FunH2>
        <WideGrid>
          <WideContainer>
            Building this structure in CAD was interesting--especially fun to
            get the gears to work properly:
            <div className="my-4">
              <Image
          ...
          <WideContainer>
            Ok so the gears on the top work! Just about... all nine surrounding
            do work but between all the connections they end up getting stuck in
            the corrugated cardboard :( but it is still a proof of concept.
            <div className="my-4">
              <Image
                src="/top-gears.gif"
          ...
          <WideContainer>
            <p>
              ...
              carousel. As the motor turns its own gear it turns the carousel
              base around it.
            </p>
            <div className="my-4">
              <Image
        ...
        <WideGrid>
          ...
          <WideContainer>
            <p>
              ...
              attached to have the same number of teeth as the fixed central
              gear, each earring does one revolution in the same time the
              carousel does one revolution. Their spinning movement is therefore
              not discernible.
            </p>
            <br />
            <p>
              I need the nine earring gears to have 1/4 the number of teeth as
              the central gear.
            </p>
          </WideContainer>
          <WideContainer>
            <p>
              The corrugated cardboard means the interconnecting face of the
              gear teeth does not have a true surface. This mean the gears got
              caught on each other. It works as a proof of concept but I need to
              trace the gears onto a real 3D material like acrylic.
            </p>
            <div className="my-4">
              <Image
                src="/janky-gears.gif"
        ...
        <FunH2>Circuit voltage and current</FunH2>
        <WideGrid>
          <WideContainer>
            ...
            />
            <p>
              My average resistance reading (also parallel across the motor)
            </p>
            ...
            <p>
              Therefore this circuit is drawing a current of 1.4 volts / 1805
              ohms = 0.78 milliamps. I think itʼs a series circuit so the
